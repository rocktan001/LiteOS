...
OperationSourceFile()
{
    if [ ${g_boardName} = "GD32E103C_START" ]; then
        cp  ${g_sourceFile}/Firmware/CMSIS/GD/GD32E10x/Include/* ../../../${g_boardName}/Inc
        cp  ${g_sourceFile}/Firmware/CMSIS/GD/GD32E10x/Source/system_gd32e10x.c  ../../../${g_boardName}/Src
...
CopySourceFile()
{
    ...
    tmpName="`unrar lb GD32E10x_Firmware_Library.rar | tail -n 1`"
